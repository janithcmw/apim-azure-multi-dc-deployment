...
#data "azurerm_virtual_network" "shared_vnet" { #commented due to role issue
...
#  vnet_dest_id                        = data.azurerm_virtual_network.shared_vnet.id  #commented due to role issue
